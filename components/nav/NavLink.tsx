...
export default function NavLink({ href, label, active = false, external, onClick }: NavLinkProps) {
  const baseClasses = 'relative inline-flex items-center px-3 py-2 text-sm font-semibold text-ink-700 transition-colors hover:text-ink-900'
